...
class AdvertiserplansController extends Controller
{
	/**
	...
	public function accessRules()
	{
		return array(
				array('allow',  // allow all users to perform 'index' and 'view' actions
						...
						'roles'=>array(UserType::TYPE_WHITELABELADMIN, UserType::TYPE_SUPERADMIN),
					),
	...
	public function actionIndex()
	{
		...
		if(isset($_POST['PurchasedPlan']))
		{
			...
			if($form->validate()) {
				//echo "AP: ".$form->advertiser_id."|";
				$form->purchasePlan($this->getPlanType(), $form->advertiser_id);
