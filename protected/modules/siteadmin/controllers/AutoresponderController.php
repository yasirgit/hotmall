...
class AutoresponderController extends Controller
{
	...
	public function actionIndex()
	{
		...
		$autoresponders=AutoresponderManager::load($model);
		
		if(isset($_POST['Autoresponder']))
		{
			$model->attributes=$_POST['Autoresponder'];
			$autoresponders->manage($_POST['Autoresponder']);
			
            $valid=$autoresponders->validate($model);
            
            if($valid)
            {			
            	if(!$autoresponders->save($model)) {
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='autoresponder-form')
		{
