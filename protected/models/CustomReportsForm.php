 ...
 */
class CustomReportsForm extends CFormModel
{
	public $dateFrom;
	public $dateTo;
	...
	public function loadDatesFromSession() {
		$this->dateFrom = Yii::app()->user->getState('qsFrom', '2011-01-01 00:00:00');
		$this->dateTo = Yii::app()->user->getState('qsTo', '2011-01-01 00:00:00');
	}
}
