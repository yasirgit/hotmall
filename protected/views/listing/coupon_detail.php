		...
		<!-- Coupon Box Padding Div Start -->
			...
			<!-- Coupon Starts -->
				...
				<div class="disclaimer-code">
					...
					<ul class="content-menu coupon-page activate">
					<li>
						<a class="coupon-redeem" href="<?php echo Yii::app()->createUrl('listing/coupon_activate', array('id'=>$coupon->coupon_id)); ?>">Activate</a>
					</li>
					</ul>
<!--					
